...
export default function HomeClient({ posts }: { posts: PostType[] }) {
  ...
  const deptsData = [
    { name: "會本部", desc: "部門簡介尚未提供，敬請期待。" },
    { name: "秘書處", desc: "部門簡介尚未提供，敬請期待。" },
    { name: "學術部", desc: "部門簡介尚未提供，敬請期待。" },
    {
        name: "公關部",
    ...
    { name: "財務部", desc: "負責預決算編列、會內請款報帳、校內核銷與控管會內整體財務狀況" },
    { name: "國際部", desc: "部門簡介尚未提供，敬請期待。" },
    { name: "選舉罷免執行委員會", desc: "部門簡介尚未提供，敬請期待。" }
  ];
    ...
    <>
      ...
      <section className={`page ${activeTab === "home" ? "active" : ""}`} id="home">
        <div className="hero" style={{ padding: 0 }}>
          <div className="fade-up-target" style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
            <InteractiveCard />
          </div>
              ...
              posts.map((post) => (
                <article key={post.id} className="news-card fade-up-target" role="article">
                  <div 
                    ...
                    style={post.coverImage ? { backgroundImage: `url(${post.coverImage})`, backgroundSize: 'cover', backgroundPosition: 'center' } : {}}
                  >
                    {!post.coverImage && "📄"}
                  </div>
      ...
      <section className={`page ${activeTab === "about" ? "active" : ""}`} id="about">
        ...
        <div className="section-wrap">
          ...
          <div className="about-body fade-up-target">
            ...
            <p>臺大學生會最早可以追溯至戰後初期由各學院學生自治會會組成的「學生自治會聯合會」。不過在 1949 年「四六事件」爆發以後，學校加強對學生自治團體的管理。改為由各學院組成院學生代表會與「一年級學生代表會」共同組成「各學院學生代表會聯合會」，選出正副主席與各部總幹事，即是學生會的前身代聯會。</p>
            ...
            <p>前幾屆臺大學生會，在野百合學運帶起的學生運動風潮下，成為進步議題的橋頭堡。第二屆學生會長范雲、第三屆林奕華、第六屆黃國昌後來都走上從政的道路。投票率也都在 30% 以上。在此期間，學生會也促使立法院在 1993 年修正大學法，確立大學自治的制度保障。1994 年在校務會議推動廢除必修軍護課程。同時因應大學法的修正，臺大在 1993 - 1994 年間進行了臺大組織規程的修正，圍繞組織規程開啟了校務會議學生代表比例、產生方式、學生會與研究生協會權限分配、學生會費收取的討論。1995 年學生法院做出解釋第三號，確立研究生屬於臺大學生會的當然會員。</p>
            ...
            <p>2025 年，學生會出現了當了一分鐘的會長。2026 年三月，時任學生會長陳柏承成為首位被罷免的學生會長。從代聯會到大學生會，我們始終都承載著臺大學生探索民主的歷程，背負「塑造自由平等之社會，建設民主法治之國家」的夢想。</p>
          </div>
        </div>
